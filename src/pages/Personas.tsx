...
const Personas = () => {
  ...
  const loadPersonas = async () => {
    const {
      data
    } = await supabase.from("personas").select("*").order("created_at", {
      ascending: false
    });
      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="p-4">
          <div className="relative">
            ...
            <Input placeholder="Search personas..." className="pl-10" />
          </div>
        </Card>
          ...
          return <Card key={persona.id} className="p-6 hover:border-primary/50 transition-all group">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    ...
                    <div className="flex-1 h-2 bg-muted rounded-full overflow-hidden">
                      <div className="h-full bg-success transition-all" style={{
                      width: `${persona.trustScore * 100}%`
                    }} />
                    </div>
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap gap-2">
                  {(Array.isArray(traits) ? traits : []).map((trait, idx) => <Badge key={idx} variant="secondary" className="text-xs">
